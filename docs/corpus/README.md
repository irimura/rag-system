...
[テストデータ集](../test-data.md) §1 の推奨コーパスを、動作確認・精度評価・負荷/規模試験の3段階で取得、前処理、配置、投入、検収するための手順書です。
...
実行前に [Node B構築手順](../deployment-guide.md) の対象案を完了し、初回のコンテナイメージ・モデル取得を済ませてください。
