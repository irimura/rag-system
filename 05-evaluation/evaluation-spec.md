...
| **公開データセット流用** | 別トラック | JSQuAD 等「コーパスと QA が対で揃っている」データセットでパイプライン自体を検証([評価用データセット](eval-datasets.md) 参照) |
...
- 日本語固有の観点(表記ゆれ・漢語/和語言い換え)は TC03/TC04 に含めて作る([RAG 構成要素解説](../06-tuning/README.md) の各節参照)
